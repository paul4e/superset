...
from superset.reports_integration.views.mixins import ReportEngineMixin


class ReportEngineView(SupersetModelView, ReportEngineMixin):
    route_base = "/report_engines"

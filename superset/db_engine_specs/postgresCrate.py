...
class PostgresCrateBaseEngineSpec(BaseEngineSpec):
    """ Abstract class for Postgres 'like' databases """

    engine = ""
    engine_name = "PostgresqlCrate"
...
class PostgresCrateEngineSpec(PostgresCrateBaseEngineSpec, BasicParametersMixin):
    engine = "PostgresqlCrate"
    engine_aliases = {"PostgresqlCrate"}

    default_driver = "postgresqlCrate"
    sqlalchemy_uri_placeholder = (
        "postgresqlCrate://user@host:port/[?key=value&key=value...]"
    )
